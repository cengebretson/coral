function _coral_load_config
    ...
    set -f config_names CORAL_BASE_BRANCHES CORAL_CACHE_TTL CORAL_COLOR_ACCENT CORAL_COLOR_BG CORAL_COLOR_DANGER CORAL_COLOR_MUTED CORAL_COLOR_TEXT CORAL_JIRA_KEY_PATTERN CORAL_JIRA_URL_TEMPLATE CORAL_LIST_MODE CORAL_PR_BATCH_SIZE CORAL_PR_HISTORY_DAYS
